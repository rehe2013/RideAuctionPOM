...
import static com.rideauction.webtest.framework.Constants.*;
 ...
 */
	...
	public void WaitForElementPresent (WebElement element,long timeInSecs){
		assertNotNull(element);
		WebDriverWait wait=new WebDriverWait(driver,timeInSecs);
	...
	public void verifyElementContainText(WebElement element,String text){
		Assert.assertNotNull(element);
		Assert.assertTrue(element.getText().contentEquals(text));
